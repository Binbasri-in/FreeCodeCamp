...
def calculate_demographic_data(print_data=True):
    ...
    percentage_bachelors = percentage_bachelors = df['education'][df['education'] == 'Bachelors'].count()/df['education'].count() * 100
...
# percentage with salary >50K
    ...
    top_IN_occupation_1 = df['occupation'][(df['salary'] == '>50K') & (df['native-country'] == 'India')].value_counts()
    top_IN_occupation = top_IN_occupation_1[0]
